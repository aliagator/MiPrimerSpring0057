...
public class CursoRestController {
    ...
    @GetMapping("/{id}")
    public Curso listarCursoID(@PathVariable int id) { return objCursoService.listarCursoID(id);}
    ...
    @GetMapping
    public List<Curso> listarCurso() { return objCursoService.listarCurso();}
}
